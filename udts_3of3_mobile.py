...
def add_confirmation_filter(df, only_confirmed=False):
    ...
    result = df.copy()
    fields = [
        "CPR", "VWAP", "EMA", "RSI", "RVOL", "ADX",
        "Avg Traded Value (₹)", "Target Traded Value (₹)",
        "CPR Pivot", "CPR TC", "CPR BC",
        "VWAP Value", "EMA 21", "EMA 34",
        "Confirm Score", "Confirmation", "Indicator Date", "Indicator TF"
    ]
    for field in fields:
